...
WebUI.click(findTestObject('Project/Add project/List Projects button'))

WebUI.click(findTestObject('Project/Add project/Add Item'))

WebUI.verifyElementText(findTestObject('Project/Add project/Create Project'), 'Create Project')

WebUI.setText(findTestObject('Project/Add project/Title'), 'test project')

WebUI.click(findTestObject('Project/Add project/Choose category'))

WebUI.setText(findTestObject('Project/Add project/Search category'), 'UI')

WebUI.sendKeys(findTestObject('Project/Add project/Search category'), Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('Project/Add project/Desc'), 'ini adalah deskripsi')

WebUI.uploadFile(findTestObject('Project/Add project/Poster'), 'C:\\FILE\\TA\\logo.png')

WebUI.setText(findTestObject('Project/Add project/Supervisor'), 'test supervisor')
